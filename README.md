...
5. (Optional) Check the **Force Handbrake** option to automatically repair and re-encode problem videos *before* they are imported.
6. Click **Download & Import**.

**After Import Options:**
- If you didn't check **Force Handbrake** beforehand and encounter playback issues with a downloaded video, you can use the **Repair and Re-encode** option to fix those specific videos after they've been imported.
